...
<html lang="en" ng-app="skill--app">
    ...
    <body  class="hold-transition skin-blue sidebar-mini" ng-controller="skill__controller">   
        <div class="wrapper"> 
        ...
        <script src="../../../../../resources/scripts/backend/angular/skill.js" type="text/javascript"></script>
    </body>
</html>