...
<html lang="en" ng-app="level--app">
    ...
    <body class="hold-transition skin-blue sidebar-mini" ng-controller="level__controller">   
        <div class="wrapper"> 
        ...
        <script src="../../../../../resources/scripts/backend/angular/level.js" type="text/javascript"></script>
    </body>
</html>