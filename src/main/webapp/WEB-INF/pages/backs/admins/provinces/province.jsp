...
<html lang="en" ng-app="location--app">
    <head>
        <meta charset="utf-8">
    ...
    <body class="hold-transition skin-blue sidebar-mini" ng-controller="location__controller">   
        <div class="wrapper"> 
            ...
            <div class="content-wrapper">                                
                <section class="content">
                    ...
                    <jsp:include page="includes/province-list.jsp"/>
                </section>
            </div>             
        ...
        <script src="../../../../../resources/scripts/backend/angular/location.js" type="text/javascript"></script>
    </body>
</html>