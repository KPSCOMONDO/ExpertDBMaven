...
<html lang="en" ng-app="skill-category--app">
    <head>
        <meta charset="utf-8">
    ...
    <body  class="hold-transition skin-blue sidebar-mini" ng-controller="skill_category__controller">   
        <div class="wrapper"> 
            ...
            <div class="content-wrapper">                                
                <section class="content">
                    ...
                    <jsp:include page="includes/skill-category-list.jsp"/>
                </section>
            </div>             
        ...
        <script src="../../../../../resources/scripts/backend/angular/skillcategory.js" type="text/javascript"></script>
