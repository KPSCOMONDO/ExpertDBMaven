...
<html lang="en" ng-app="language--app">
    <head>
        <meta charset="utf-8">
    ...
    <body  class="hold-transition skin-blue sidebar-mini" ng-controller="language__controller">   
        <div class="wrapper"> 
            ...
            <div class="content-wrapper">                                
                <section class="content">
                    ...
                    <jsp:include page="includes/language-list.jsp"/>
                </section>
            </div>             
        ...
        <script src="../../../../../resources/scripts/backend/angular/language.js" type="text/javascript"></script>
    </body>
</html>